...
WASM_IMPORT("uart_write", int uart_write(unsigned int handle, unsigned char word));
WASM_IMPORT("uart_read", int uart_read(unsigned int handle, unsigned char* word));
